...
The workflow of this study included several processes and approaches to image analysis and multi-source data, summarised in the methodological scheme in Figure \ref{fig04}.
...
\begin{figure}[H]
  ...
  \end{tabular}
   \begin{tabular}[b]{c}
    \includegraphics[width=6.3cm]{Fig_10e.jpg} \\
    \small (e): 2023 
  \end{tabular}
  \begin{tabular}[b]{c}
    \includegraphics[width=6.3cm]{Fig_10f.jpg} \\
    \small (f): 2024
  \end{tabular}
