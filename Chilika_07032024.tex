...
\begin{figure}[H]
  \centering
  \begin{tabular}[b]{c}
    \includegraphics[width=6.4cm]{Fig_05a.jpg} \\
    \small (a): 2019 
  \end{tabular}
  \begin{tabular}[b]{c}
    \includegraphics[width=6.4cm]{Fig_05b.jpg} \\
    \small (b): 2020 
  \end{tabular}
    \begin{tabular}[b]{c}
    \includegraphics[width=6.4cm]{Fig_05c.jpg} \\
    \small (c): 2021
  \end{tabular}
  \begin{tabular}[b]{c}
    \includegraphics[width=6.4cm]{Fig_05d.jpg} \\
    \small (d): 2022 
  \end{tabular}
   \begin{tabular}[b]{c}
    \includegraphics[width=6.4cm]{Fig_05e.jpg} \\
    \small (e): 2023 
  \end{tabular}
  \begin{tabular}[b]{c}
    \includegraphics[width=6.4cm]{Fig_05f.jpg} \\
    \small (f): 2024
  \end{tabular}
