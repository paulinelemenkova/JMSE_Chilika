...
\begin{table}[H]
  ...
  \begin{tabular}{| ccccccccccc |}
    \textbf{Year} & Class 1 & Class 2 & Class 3 & Class 4 & Class 5 & Class 6 & Class 7 & Class 8 & Class 9 & Class 10 \\
    \hline
    \hline
    \textbf{2019}  & X & X & X & X & X & X & X & X & X & X\\
    \textbf{2020}  & X & X & X & X & X & X & X & X & X & X \\
    \textbf{2021} & X & X & X & X & X & X & X & X & X & X \\
    \textbf{2022} & X & X & X & X & X & X & X & X & X & X \\
     \textbf{2023} & X & X & X & X & X & X & X & X & X & X \\
    \textbf{2024}  & X & X & X & X & X & X & X & X & X & X \\
  \end{tabular}
  \caption{Statistical results on the estimated classes of land cover types for the decade period (2019--2024) in Chilika Lake coastal lagoon}
  \label{tab01}
\end{table}
