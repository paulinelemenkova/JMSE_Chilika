...
\begin{table}[H] 
\caption{{Estimated} %MDPI: Table 1 and Table A2 have same labels {tab01}. Please check and revise. Please mention Table 1 before and close to where it is first presented in the text, and make sure all tables are mentioned in numerical order. %Author: caption of Table A2 in Appendix is corrected (and its reference in the text). The references of Tables are checked.
