...
%MDPI: Please note: 1. Figures and Tables should be cited after where they are first mentioned, we have adjusted all. 2. The size and position of figures/tables will be adjusted appropriately to avoid blank space and to ensure the clarity and readability of the image during the final steps. %Author: many thanks, yes, I agree and confirm all the changes.
    \label{fig01}
\end{figure}
